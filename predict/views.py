...
class DiabetesPredict(LoginRequiredMixin,View):
    model_path = os.path.join(settings.BASE_DIR, "ml_models", "models", "diabetes.pkl")
...
class HeartPrediction(LoginRequiredMixin,View):
    model_path = os.path.join(settings.BASE_DIR, "ml_models", "models", "heart_disease.joblib")
...
class BreastCancerPredict(LoginRequiredMixin,View):
    model_path = os.path.join(settings.BASE_DIR, "ml_models", "models", "breast_cancer.joblib")
...
class LiverPredict(LoginRequiredMixin,View):
    model_path = os.path.join(settings.BASE_DIR, "ml_models", "models", "liver.joblib")
...
class KidneyPredict(LoginRequiredMixin,View):
    model_path = os.path.join(settings.BASE_DIR, "ml_models", "models", "kidney_model.joblib")
